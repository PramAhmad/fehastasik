<template >
  <div>
    <footer class="border-t border-slate-300" aria-labelledby="footer-heading">
      <h2 id="footer-heading" class="sr-only">Footer</h2>
      <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
          <div class="space-y-8">
            <img class="h-10" src="../assets/hastasik.png" alt="Company name" />
            <p class="text-sm leading-6 text-gray-600">
              Hastasik adalah sebuah platform e-commerce yang menyediakan
              berbagai macam produk khas dari tasikmalaya. Kami berkomitmen
              untuk memberikan produk-produk terbaik dari tasikmalaya.
            </p>
