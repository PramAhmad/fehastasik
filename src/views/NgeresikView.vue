<template >
  <div>
    ...
    <div class="container">
      <div
        class="relative isolate px-6 pt-28 mt-5 lg:px-8 md:h-full min-h-screen"
      >
        <div
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div class="hidden sm:mb-8 sm:flex sm:justify-center">
            ...
            >
              Merilis jasa baru dari hsatasik.
              <a href="#" class="font-semibold text-sky-600"
                ><span class="absolute inset-0" aria-hidden="true"></span>Baca
          ...
          <div class="text-center">
            ...
            >
              Ngeresik - Jalan Jalan Kota Tasikmalaya
            </h1>
            <p class="mt-6 text-lg leading-8 text-gray-600">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              Aspernatur facilis veritatis itaque eius, rerum velit magnam sequi
              magni odio impedit!
            </p>
        ...
        <div class="overflow-hidden py-24 sm:py-32">
          <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            >
              ...
              <img
                src="https://lh3.googleusercontent.com/pw/AP1GczNZLmZvd7gqSOqnGAPQJmey7WCQN8poD-hbaiezj0M0VH4OEvGqNadAPKGfB6UDeZqQasHVN4MO31SbdZrWx_d7ojOfohbZaZitf1ytoH8nRQMHI7FwyWGurlM1PGPs00Nba-PnbDc0-z88PCbnbUdt=w1657-h932-s-no-gm?authuser=0"
          ...
          <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl sm:text-center">
              ...
              <p class="mt-6 text-lg leading-8 text-gray-600">
                ...
                ipsum odio adipisci eius voluptates quis!
              </p>
            </div>
            <div
            ...
            >
              <div class="p-8 sm:p-10 lg:flex-auto">
                ...
                <div class="mt-10 flex items-center gap-x-4">
                  <h4
                    class="flex-none text-sm font-semibold leading-6 text-sky-600"
                  >
              ...
              >
                ...
                >
                  <div class="mx-auto max-w-xs px-8">
                    ...
                    <a
                      href="#"
                      class="mt-10 block w-full rounded-md bg-sky-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600"
                      >Dapatkan Sekarang</a
                    >
                  </div>
                </div>
